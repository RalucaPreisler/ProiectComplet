...
(function (_astar) {
    ...
    })(_astar.GraphNodeType || (_astar.GraphNodeType = {}));
    var GraphNodeType = _astar.GraphNodeType;
    var Graph = (function () {
        function Graph(grid) {
            this.elements = grid;
            var nodes = [];
    ...
    var GraphNode = (function () {
        ...
        GraphNode.prototype.isWall = function () {
            return this.type == 0 /* WALL */;
        };
        return GraphNode;
    })();
    _astar.GraphNode = GraphNode;
